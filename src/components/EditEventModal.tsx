...
const featureOptions = ['Networking', 'Certificates', 'Recording', 'Meals Included', 'Premium Materials', 'VIP Access', 'Swag Bag'];
    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      ...
      <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-8 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-white font-semibold mb-2">Attractions/Speakers</label>
              <input
                type="text"
          ...
          <div>
            <label className="block text-white font-semibold mb-3">Features</label>
